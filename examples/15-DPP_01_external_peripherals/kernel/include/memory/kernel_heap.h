...
// pomocne implementace pro kernel heap - tento soubor je includovat vyhradne z kernel-only implementaci, a tak proste
// jen presmerujeme vsechna volani new/delete na tyto implementace, ktere alokuji a uvolnuji pamet z haldy jadra
