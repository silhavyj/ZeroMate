...
enum class NSWI_Process_Service
{
    ...
    // IN:  r0 = pocet tiku casovace, na kolik uspat proces, r1 = nova deadline po probuzeni (nebo Deadline_Unchanged
    // pokud se nema menit, nebo Indefinite pokud se ma zrusit) OUT: r0 = indikator uspechu (NSWI_Result_Code), OK pokud
    // se probudil po casovem useku, Fail pokud ho probudilo neco jineho
    Sleep = 3,
...
enum class NSWI_Filesystem_Service
{
    ...
    // IN:  r0 = handle otevreneho souboru, r1 = pocet zdroju, r2 = nova deadline po probuzeni (nebo Deadline_Unchanged
    // pokud se nema menit, nebo Indefinite pokud se ma zrusit) OUT: r0 = indikator uspechu (NSWI_Result_Code)
    Wait = 6,
};
