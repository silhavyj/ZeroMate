...
namespace zero_mate::arm1176jzf_s
{
    ...
    private:
        ...
        // clang-format off
        std::array<TInstruction_Lookup_Record, 6> INSTRUCTION_LOOKUP_TABLE = {{
            { .mask = 0b0000'1111'1111'1111'1111'1111'1101'0000U, .expected = 0b0000'0001'0010'1111'1111'1111'0001'0000U, .type = isa::CInstruction::NType::Branch_And_Exchange  },
