...
namespace zero_mate
{
    ...
    public:
        ...
        ///
        /// The bus needs to have access to this coprocessor to determine
        /// whether it should check for unaligned memory accesses or not.
        ///
        ...
        ///
        /// The bus width size is usually fixed. The generic type is supported
        /// only for emulation purposes - simplifications.
        ///
    ...
    private:
        ...
        ///
        /// It searches for a peripheral mapped to the region determined by the given address.
        /// It also checks memory access alignment, if enabled in CP15.
        ///
        ...
        /// If a peripheral was found, it also checks if the given address exceeds the size of the peripheral or not.
        ///
        ...
        ///
        /// Since peripheral cannot overlap, a binary search can be used to find
        /// a peripheral by the given address.
        ///
