...
{
    // clang-format off
    std::array<CISA_Decoder::TInstruction_Lookup_Record, CISA_Decoder::Instruction_Masks_Count> CISA_Decoder::s_instruction_lookup_table = {{
    ...
    { .mask = 0b0000'1111'1111'0000'1111'0000'1001'0000U, .expected = 0b0000'0001'0110'0000'0000'0000'1000'0000U, .type = CInstruction::NType::SMULxy                        },
    { .mask = 0b0000'1111'1111'0000'1111'0000'1011'0000U, .expected = 0b0000'0001'0010'0000'0000'0000'1010'0000U, .type = CInstruction::NType::SMULWy                        },
    { .mask = 0b0000'1111'1111'0000'0000'0000'1001'0000U, .expected = 0b0000'0001'0000'0000'0000'0000'1000'0000U, .type = CInstruction::NType::SMLAxy                        },
    { .mask = 0b0000'1111'1111'0000'0000'0000'1011'0000U, .expected = 0b0000'0001'0010'0000'0000'0000'1000'0000U, .type = CInstruction::NType::SMLAWy                        }
    }};
    // clang-format on
