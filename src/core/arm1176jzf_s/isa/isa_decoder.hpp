...
namespace zero_mate::arm1176jzf_s::isa
{
    ...
    private:
        static constexpr std::size_t NUMBER_OF_INSTRUCTION_MASKS = 15;

        static std::array<TInstruction_Lookup_Record, NUMBER_OF_INSTRUCTION_MASKS> s_instruction_lookup_table;
    };
}