...
\begin{frame}
	...
	\begin{overlayarea}{\textwidth}{\textheight}
		\begin{figure}
			...
			\only<3>
			{%
				\normalsize \textcolor{UBCblue}{(3) registry \texttt{CPU} a systémový koprocesor}\\
				\vspace{0.1cm}
...
\begin{frame}
	...
	\begin{overlayarea}{\textwidth}{\textheight}
		\begin{figure}
			...
			\only<1>
			{%
				\normalsize \textcolor{UBCblue}{(1) tlačítko (další periferie viz  \href{https://home.zcu.cz/~ublm/files/os/kiv-dpp-01-en.pdf}{\beamergotobutton{KIV-DPP-01}})}\\
				\vspace{0.1cm}
...
\begin{frame}
	...
	\end{figure}
	\footnote{\vspace{0.5cm}\tiny Měřeno na: Lenovo ThinkPad P50 laptop; Windows 10; Intel(R) Core(TM) i7-6820HQ; \texttt{2.70GHz}; \texttt{16GB}}
\end{frame}
