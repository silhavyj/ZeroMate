...
\begin{frame}
	...
	\vspace{-0.3cm}
	\begin{itemize}
		\item závislosti automaticky staženy a sestaveny \\ (\texttt{.gitmodules} + \texttt{CMake})
		\begin{itemize}
...
\begin{frame}
	\begin{block}{1) Unit testy}
		\begin{itemize}
			...
			\item GoogleTest, \texttt{CI} (regresní testy)
			\item pokrytí $\approx$ 78\%
		\end{itemize}
	\end{block}
...
\begin{frame}
	\begin{itemize}
		\item výkonost emulace $\approx$ 4-5 Minst/s (\href{https://github.com/MartinUbl/KIV-RTOS}{\beamergotobutton{KIV-RTOS}})
...
\subsection{Porovnání výkonosti s ostatními emulátory}
...
\begin{frame}
	...
	\vspace{-0.4cm}
	\begin{itemize}
		\item pouze orientační (\href{https://cpulator.01xz.net/}{\beamergotobutton{https://cpulator.01xz.net/}})
