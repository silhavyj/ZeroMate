...
TEST(vnmla, test_01)
{
    ...
    const float result_float{ 123456.8906F };
    const std::uint32_t result_uint32{ 0x47f12072 };
...
TEST(vnmla, test_02)
{
    ...
    const float result_float{ 795.3321533F };
    const std::uint32_t result_uint32{ 0x4446d542 };
