...
TEST(mvn_instruction, test_01)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[5], 0xFFFFFFFF);
...
TEST(mvn_instruction, test_02)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0b00011111'11111111'11111111'11111111);
...
TEST(mvn_instruction, test_03)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[6], 0xFFFFFFFF);
...
TEST(mvn_instruction, test_04)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[6], 0b10000000'00000000'00000000'00000001);
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0xFFFFFFFC);
...
TEST(mvn_instruction, test_05)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[11], 0x0FFFFFF4);
...
TEST(mvn_instruction, test_06)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0x7FFFFFFF);
...
TEST(mvn_instruction, test_07)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0xFFFFFFFF);
