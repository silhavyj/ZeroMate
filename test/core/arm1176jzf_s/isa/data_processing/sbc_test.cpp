...
TEST(sbc_instruction, test_11)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[2], 0x3FFFF);
    EXPECT_EQ(cpu.Get_CPU_Context()[3], 0x40000);
...
TEST(sbc_instruction, test_12)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[2], 0xFFFDFFFD);
    EXPECT_EQ(cpu.Get_CPU_Context()[3], 0xFFFDFFFE);
