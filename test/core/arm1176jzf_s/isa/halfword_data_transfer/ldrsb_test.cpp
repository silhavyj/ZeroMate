...
TEST(ldrsb_instruction, test_01)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0xFFFFFFFB);
    EXPECT_EQ(cpu.Get_CPU_Context()[1], 0x000000C7);
    EXPECT_EQ(cpu.Get_CPU_Context()[2], 0xFFFFFFFB);
}
...
TEST(ldrsb_instruction, test_02)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0xFFFFFFBC);
    EXPECT_EQ(cpu.Get_CPU_Context()[1], 0x000000C8);
    EXPECT_EQ(cpu.Get_CPU_Context()[2], 0x000000BC);
}
...
TEST(ldrsb_instruction, test_03)
{
    ...
    EXPECT_EQ(cpu.Get_CPU_Context()[0], 0x0000000C);
    EXPECT_EQ(cpu.Get_CPU_Context()[1], 0x000000C7);
    EXPECT_EQ(cpu.Get_CPU_Context()[2], 0x0000000C);
}