...
TEST(uxtb16_instruction, test_01)
{
    ...
    EXPECT_EQ(cpu.m_regs[3], 0x00FF0054);
}
...
TEST(uxtb16_instruction, test_02)
{
    ...
    EXPECT_EQ(cpu.m_regs[3], 0x00FF00FF);
}
...
TEST(uxtb16_instruction, test_03)
{
    ...
    EXPECT_EQ(cpu.m_regs[3], 0x00000080);
}
...
TEST(uxtb16_instruction, test_04)
{
    ...
    EXPECT_EQ(cpu.m_regs[3], 0x00010000);
}
...
TEST(uxtb16_instruction, test_05)
{
    ...
    EXPECT_EQ(cpu.m_regs[2], 0x00FF00FF);
}