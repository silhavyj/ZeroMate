...
TEST(cps_instruction, test_01)
{
    ...
    EXPECT_EQ(cpu.m_context.Is_Flag_Set(CCPU_Context::NFlag::F), false);
    ...
    EXPECT_EQ(cpu.m_context.Is_Flag_Set(CCPU_Context::NFlag::F), true);
...
TEST(cps_instruction, test_02)
{
    ...
    EXPECT_EQ(cpu.m_context.Get_CPU_Mode(), CCPU_Context::NCPU_Mode::IRQ);
}
...
TEST(cps_instruction, test_03)
{
    ...
    EXPECT_EQ(cpu.m_context.Is_Flag_Set(CCPU_Context::NFlag::I), true);
    EXPECT_EQ(cpu.m_context.Is_Flag_Set(CCPU_Context::NFlag::A), true);

    EXPECT_EQ(cpu.m_context.Get_CPU_Mode(), CCPU_Context::NCPU_Mode::FIQ);
}